...
Configure sacred translation settings as top-level keys in `.manuscript/config.json`. For full details on sacred text work types, voice registers, and exclusive commands, see the Sacred Text Guide.
