# Claude Code Host Capture

Status: queued.

Evidence level: host-capture-ready.

This directory is reserved for the first real Claude Code host-runtime transcript. It is not marked verified until `TRANSCRIPT.md` or an equivalent screenshot artifact is committed from an actual Claude Code run that follows [HOST-CAPTURE-PROTOCOL.md](../HOST-CAPTURE-PROTOCOL.md).
