...
This directory is reserved for a real Codex host-runtime transcript. It is not marked verified until `TRANSCRIPT.md` or an equivalent screenshot artifact is committed from an actual Codex run that follows [HOST-CAPTURE-PROTOCOL.md](../HOST-CAPTURE-PROTOCOL.md).
...
- The host recognizes the installed `$scr-*` skills.
