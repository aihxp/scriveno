...
The wedge comes first: Scriveno profiles the writer, loads that voice into every drafting step, and keeps each unit on fresh context so the prose stays specific to the project. From there, it expands into 124 writing commands covering the rest of the pipeline:
...
- [Command Reference](docs/command-reference.md) -- All 124 commands with usage, flags, and examples
